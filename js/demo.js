(function() {
    ...
    var textOptions = {
        ...
        // }
        translate: function() {
            if (windowWidth > 1120) return {translateX: 200, translateY: 300};
            if (windowWidth > 720) return {translateX: 20, translateY: 300};
    ...
    var numberOptions = {
        ...
        // }
        translate: function() {
            if (windowWidth > 1120) return {translateX: -380, translateY: -240};
            if (windowWidth > 720) return {translateX: -260, translateY: -200};
            return {translateX: -160, translateY: -120};
        }
    };
